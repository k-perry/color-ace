...
export default class AdjustLuminance extends Component {
	...
	render() {
		return (
			<div className="center" style={{ fontSize: '0.85rem', padding: '0.5rem 0.1rem' }}>
						...
						return (
							<div key={idx}>
								<button
									...
									style={{ margin: '0.2rem 0', minWidth: '2.5rem' }}
									onClick={() => this.props.onClick(this.props.buttonAmounts[idx])}
