					...
					>
						<tbody>
							<tr style={{ border: '0', cursor: 'default' }}>
								<td style={{ backgroundColor: this.state.currentHex, width: '25%' }} />
								<td style={{ width: '32%' }}>{this.state.currentHex ? this.state.currentHex : null}</td>
								<td style={{ width: '43%' }}>
									{this.state.currentRGB ? (
										<React.Fragment>
											rgb({this.state.currentRGB[0]},{this.state.currentRGB[1]},
