...
class App extends Component {
	...
	onSaveColor = (color) => {
		this.setState({ savedColors: [ ...this.state.savedColors, color ] }, () => {
	...
	render() {
		return (
			<div className="App">
				{/* Left column */}
				<div style={{ float: 'left', width: 'fit-content', padding: '1rem' }}>
					<CurrentColor ref={(child) => (this.currentColor = child)} onSave={this.onSaveColor} />
					<br />
					<SavedColors
				...
				{/* Right column */}
				<div style={{ float: 'left', minWidth: '570px', padding: '1rem' }}>
